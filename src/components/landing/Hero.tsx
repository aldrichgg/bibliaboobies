  ...
  return (
    <section className="container grid lg:grid-cols-2 gap-12 items-center py-20 md:py-32">
      <div className="flex flex-col items-start space-y-6">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold font-headline tracking-tight text-primary-dark animate-bounce-slow">
      ...
      <div className="relative w-full h-80 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl shadow-blue-200/50">
        <Image
